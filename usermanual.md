...
In night mode (default) the camera will shutdown after 15 minutes if turned on in the daytime.
...
`LED 0.0` to `LED 60.0`<br>
Fine-tuning slider for LED brightness.

`Circular On` / `Circular Off`<br>
