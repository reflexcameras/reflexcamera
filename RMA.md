...
* **Upload smaller batches** of video to Google Drive (works well for smaller projects).  
* **Courier your data** on a backed-up hard drive for large projects \- we’ll cover the return shipping cost for datasets over 10 GB.
...
Contact us via the form on this webpage and provide an estimate of the total size of all video files (in GB). A rough estimate \- such as the total used space occupied by video files on your drive \- is sufficient.
...
* Download files locally: Reviewing directly from the server can be slow. Downloading the images and videos to your computer will make loading much faster.  
* Use FastPictureViewer: This program pre-loads images, allowing you to scroll through JPEGs quickly. Just hold down the arrow key to fly through them at speed.
